...
removeVowel = (str) => {
  if (typeof str.notAString1 === "string") {
    return ("This is a string")
  } else if (typeof str.notAString1 !== "string") {
    return ("This is not a string")
  }
    else if (typeof str.notAString2 === "string") {
    return ("This is a string")
  } else {
    return ("This is not a string")
  }
...
var animals = toonimals.map(value => value.animal === "cat")
console.log(animals)
